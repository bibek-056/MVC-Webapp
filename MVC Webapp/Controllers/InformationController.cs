    ...
    public class InformationController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Information != null ? 
                          ...
                          Problem("Entity set 'MVC_WebappContext.Information'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("userId,name,password,email,phone,summary,github,linkedin,blog,designation,address")] Information information)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("userId,name,password,email,phone,summary,github,linkedin,blog,designation,address")] Information information)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!InformationExists(information.userId))
                    {
                        return NotFound();
                    }
                    else
